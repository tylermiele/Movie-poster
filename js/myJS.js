...
function normal(){
    pageBg.setAttribute("style", "background-image: url(../a3/images/movieposterBlurred.jpg)");
    pageBg3.setAttribute("style", "background-image: url(../a3/images/movieposterNoText.jpg)");
...
function alt(){
    pageBg.setAttribute("style", "background-image: url(../a3/images/movieposterALTBlurred.jpg)");
    pageBg3.setAttribute("style", "background-image: url(../a3/images/movieposterALTNoText.jpg)");
